...
def normalize_arabic_name(name):
    ...
    # نفس الشيء مع: عز الدين/عزالدين، نور الدين/نورالدين، علاء الدين، إلخ
    # الحل: إزالة المسافة بين البادئة والكلمة التالية إن بدأت بـ "ال"
    compound_prefixes = [
        'عبد', 'ابو', 'ام', 'ابن', 'ذو', 'ذي', 'ذا',
        'عز', 'نور', 'علاء', 'سيف', 'بهاء', 'ضياء', 'صلاح',
        'شمس', 'بدر', 'تقي', 'نقي', 'جلال', 'كمال', 'جمال', 'حسام',
        'فخر', 'ركن', 'محي', 'صفي', 'شرف', 'ناصر', 'سعد', 'مجد',
    ]
    for prefix in compound_prefixes:
        # نمط: <prefix> ال<شيء> → <prefix>ال<شيء>
        # مثال: "عز الدين" → "عزالدين"، "ابو الحسن" → "ابوالحسن"
